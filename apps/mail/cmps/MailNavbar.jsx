            ...
            <ul className="navbar-nav">
                ...
                <li className="nav-item">
                    <Link to='/mail' className="nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#041E49">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                ...
                <li className="nav-item">
                    <Link to='/mail/stars' className="nav-link">
                        <svg className="star-link" xmlns="http://www.w3.org/2000/svg" height="28px" viewBox="0 -960 960 960" width="28px" fill='#444746'>
                ...
                <li className="nav-item">
                    <Link to='/mail/sent' className="nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#444746">
                            <path d="M0 0h24v24H0V0z" fill="none" />
