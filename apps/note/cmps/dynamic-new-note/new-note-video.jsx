        ...
        <section className="add-note-container">
            ...
            <div className="add-note-controller">
                ...
                <form onSubmit={props.onSave}>
                    <textarea autoFocus className="textarea-add-note" id="text" name="vidUrl" value={props.note.vidUrl ? props.note.vidUrl : ''} placeholder="Enter text..." onChange={props.handleChange} />
